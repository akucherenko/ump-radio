...
$stationList['FoxNews'] = 'http://fnradio-shoutcast-32.ng.akacast.akamaistream.net/7/115/13873/v1/auth.akacast.akamaistream.net/fnradio-shoutcast-32';
...
switch ($_GET['cmd'])
{
    case 'list':
        ...
        break;
    case 'play':
        $_SESSION['play'] = $_GET['station'];
        $response['station'] = $stationList[$_GET['station']];
        break;
    case 'stop':
    ...
    case 'volume':
        isset($_GET['volume']) && $_SESSION['volume'] = $_GET['volume'];
